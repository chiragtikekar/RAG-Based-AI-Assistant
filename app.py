...
st.caption("Learn concepts from video with an AI powered RAG tutor")
# Custom CSS for UI
st.markdown("""
    <style>
    /* Main App Background */
    ...
    /* Style the Sidebar for better hierarchy */
...
with lesson_tab:
    ...
    with col2:
        st.subheader("🤖 RAG based Tutor")
        user_query = st.text_input("Ask your Query:", placeholder="e.g., What is HTML?")
